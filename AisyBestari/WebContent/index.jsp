...
<title>Aisy Bestari Tuition Center</title>
<!--
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item"><a href="login.jsp"
						class="nav-link active contact">Sign In</a></li>
				</ul>
			</div>
		</div>
	</nav>
			...
			<div class="row">
				...
				<div
					...
					<div class="hero-text">
						...
						<h1 class="text-red" data-aos="fade-up">Enroll in a course
							today!</h1>

						<a href="registerStudent.jsp" class="custom-btn btn-bg btn mt-3"
							data-aos="fade-up" data-aos-delay="100">Register now!</a> <strong
