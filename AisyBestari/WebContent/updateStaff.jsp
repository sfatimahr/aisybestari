          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-lg-8 mx-auto col-md-10 col-12">
                      ...
                      <form id="upStaffForm" name="upStaffForm" action="StaffController" method="post" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
                        <div class="row">

                         
                          <div class="col-lg-12 col-12">
                          	<label for="staffUser">Staff ID: </label><br> 
                            <input type="text" class="form-control" name="staffId" id="staffId" value="<c:out value="${staff.staffId}" />" readonly/>
                          </div>
                          
                         
                          <div class="col-lg-12 col-12">
                          	<label for="staffUser">Username : </label><br> 
                            <input type="text" class="form-control" name="staffUser" id="staffUser" value="<c:out value="${staff.staffUser}" />" />
                          </div>
                          
                          <div class="col-lg-12 col-12">
                          	<label for="staffPassword">Password : </label><br> 
                            <input type="password" class="form-control" name="staffPassword" id="staffPassword" value="<c:out value="${staff.staffPassword}" />" readonly/><br>
                          </div>

                          
                         <div class="col-lg-12 col-12">
							 <select id="staffRole" name="staffRole" size="1" class="form-control" onchange="makeSubmenu(this.value)">
							<option value="${staff.staffRole}">SELECT ROLE  </option>
					<option >STAFF</option>
					<option >MANAGER</option>
							...
							<option value="${staff.managerId}">Choose manager</option>
					<option ></option>
				</select>
				</div>
					...
					YES <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="status"  value="<c:out value="${fulltime.staffId}" />"/><br> 
					NO  <input type="radio" onclick="javascript:yesnoCheck();" name="yesno" id="status" value="<c:out value="${fulltime.staffId}" />"/><br> 
					
         			<div class="col-lg-12 col-12" id="ifYes" style="visibility:hidden">
          			Fixed allowance: <input type='text' id='fixedAllowance' name='fixedAllowance'  value="<c:out value="${fulltime.fixedAllowance}" />"/><br>
          			</div>
        			</div>
