		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8 mx-auto col-md-5 col-12">
					...
					<form id="upSubForm" name="upSubForm" action="SubjectController" method="post" class="contact-form" data-aos="fade-up" data-aos-delay="300" role="form">
						<div class="row">

							<div class="col-lg-12 col-12">
								<label for="subjectId">Subject id : </label><br> 
								<input type="text" class="form-control" name="subjectId" id="subjectId" value="<c:out value="${subject.subjectId}" />" readonly /><br>
							</div>

							<div class="col-lg-12 col-12">
								<label for="subjectName">Subject name : </label><br> 
								<input type="text" class="form-control" name="subjectName" id="subjectName" value="<c:out value="${subject.subjectName}" />" /><br>
							</div>

							<div class="col-lg-6 col-12">
								<label for="lvl">Level : </label><br> 
								<input type="text" class="form-control" name="lvl" id="lvl" value="<c:out value="${subject.lvl}" />" /><br>
							</div>

							<div class="col-lg-6 col-12">
								<label for="fee">Fee : </label><br> 
								<input type="text" class="form-control" name="fee" id="fee" value="<c:out value="${subject.fee}" />" /><br>
							</div>
